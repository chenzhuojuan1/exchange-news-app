...
const BUILTIN_RSS_KEYWORDS: Array<{ topicKey: string; keyword: string }> = [
  // 证券交易所
  { topicKey: "stock_exchange",      keyword: "bond market" },
  { topicKey: "stock_exchange",      keyword: "stock market" },
  { topicKey: "stock_exchange",      keyword: "Wall Street" },
  { topicKey: "stock_exchange",      keyword: "asset class" },
  { topicKey: "stock_exchange",      keyword: "hedge fund" },
  { topicKey: "stock_exchange",      keyword: "IPO" },
  { topicKey: "stock_exchange",      keyword: "sovereign" },
  { topicKey: "stock_exchange",      keyword: "private credit" },
  { topicKey: "stock_exchange",      keyword: "Treasury" },
  { topicKey: "stock_exchange",      keyword: "financial market" },
  // 资本市场风险
  { topicKey: "capital_market_risk", keyword: "energy shock" },
  { topicKey: "capital_market_risk", keyword: "inflation" },
  { topicKey: "capital_market_risk", keyword: "recession" },
  { topicKey: "capital_market_risk", keyword: "Fed" },
  { topicKey: "capital_market_risk", keyword: "ECB" },
  { topicKey: "capital_market_risk", keyword: "CRISIS" },
  { topicKey: "capital_market_risk", keyword: "sell-off" },
  { topicKey: "capital_market_risk", keyword: "volatility" },
  { topicKey: "capital_market_risk", keyword: "market crash" },
  { topicKey: "capital_market_risk", keyword: "OECD" },
  { topicKey: "capital_market_risk", keyword: "WFE" },
  { topicKey: "capital_market_risk", keyword: "IOSCO" },
  { topicKey: "capital_market_risk", keyword: "IMF" },
  // 绿色金融
  { topicKey: "green_finance",       keyword: "green policy" },
  { topicKey: "green_finance",       keyword: "green investment" },
  { topicKey: "green_finance",       keyword: "ESG" },
  { topicKey: "green_finance",       keyword: "climate" },
  { topicKey: "green_finance",       keyword: "renewable energy" },
  { topicKey: "green_finance",       keyword: "carbon" },
  { topicKey: "green_finance",       keyword: "net zero" },
  { topicKey: "green_finance",       keyword: "clean energy" },
  { topicKey: "green_finance",       keyword: "fossil fuel" },
  { topicKey: "green_finance",       keyword: "energy transition" },
  // 人工智能与证券市场
  { topicKey: "ai_securities",       keyword: "artificial intelligence" },
  { topicKey: "ai_securities",       keyword: "AI" },
  { topicKey: "ai_securities",       keyword: "stablecoin" },
  { topicKey: "ai_securities",       keyword: "algorithmic trading" },
  { topicKey: "ai_securities",       keyword: "high-frequency trading" },
  { topicKey: "ai_securities",       keyword: "tokenisation" },
  { topicKey: "ai_securities",       keyword: "fintech" },
  { topicKey: "ai_securities",       keyword: "digital currency" },
  { topicKey: "ai_securities",       keyword: "blockchain" },
